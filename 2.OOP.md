...
> In JavaScript, you can create static properties and methods in a class by defining them directly on the class itself,
rather than on instances of the class. Static properties and methods are associated with the class as a whole rather than with instances of the class.
